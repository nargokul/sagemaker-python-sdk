...
class TestBedrockModelBuilder:
    ...
    def test_init_with_training_job(self, mock_training_job):
        ...
        with patch.object(
            BedrockModelBuilder, "_fetch_model_package", return_value=mock_model_package
    ...
    def test_deploy_nova_model(self):
        ...
        result = builder.deploy(
            custom_model_name="test-nova-model", role_arn="arn:aws:iam::123456789012:role/test-role"
        )
    ...
    def test_get_checkpoint_uri_manifest_not_found(self):
        ...
        with patch(
            "sagemaker.serve.bedrock_model_builder.isinstance", return_value=True
